...
function syncThemeVars(target: HTMLElement) {
  const theme = document.querySelector(".radix-themes");
  if (!theme) return;

  const source = getComputedStyle(theme);
...
export function LoginBackground() {
  ...
  React.useLayoutEffect(() => {
    ...
    const update = () => syncThemeVars(wrapper);
    update();
  ...
  const paint0 = `paint0_radial_${id}`;
  const paint1 = `paint1_radial_${id}`;
  const paint2 = `paint2_radial_${id}`;
  const paint3 = `paint3_radial_${id}`;
  const paint4 = `paint4_radial_${id}`;
  const filter0 = `filter0_f_${id}`;
  ...
  return (
    ...
    >
      <svg
        className="login-page__background-svg"
      ...
      >
        ...
        <defs>
          ...
          >
            <stop style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.0833333" style={{ stopColor: "var(--accent-7)" }} />
            <stop offset="0.364583" style={{ stopColor: "var(--accent-5)" }} />
            <stop offset="0.658041" style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.798521" style={{ stopColor: "var(--accent-9)" }} />
            <stop offset="0.942708" style={{ stopColor: "var(--color-background)" }} />
          ...
          >
            <stop style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.0833333" style={{ stopColor: "var(--accent-2)" }} />
            <stop offset="0.333803" style={{ stopColor: "var(--accent-1)" }} />
            <stop offset="0.658041" style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.798521" style={{ stopColor: "var(--accent-9)" }} />
            <stop offset="0.942708" style={{ stopColor: "var(--color-background)" }} />
            <stop offset="1" style={{ stopColor: "var(--color-background)" }} />
          ...
          >
            <stop style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.140625" style={{ stopColor: "var(--accent-3)" }} />
            <stop offset="0.333803" style={{ stopColor: "var(--accent-7)" }} />
            <stop offset="0.658041" style={{ stopColor: "var(--color-background)" }} />
            <stop offset="0.798521" style={{ stopColor: "var(--accent-9)" }} />
            <stop offset="0.942708" style={{ stopColor: "var(--color-background)" }} />
            <stop offset="1" style={{ stopColor: "var(--color-background)" }} />
